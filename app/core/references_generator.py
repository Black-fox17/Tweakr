...
#     def parse_keywords(self, keywords: str) -> dict:
#         """
#         Parses the keywords field from the database.
#         Returns a dictionary with authors and other keywords.
#         """
#         if not keywords:
#             return {"authors": []}
#         try:
...
#             return {"authors": [kw.strip() for kw in keywords.split(",") if kw.strip()]}

#     def generate_apa_reference(self, paper) -> str:
#         """
#         Generates an APA-style reference for a single paper.
#         """
#         title = paper.title.capitalize()
#         parsed_keywords = self.parse_keywords(paper.keywords)
#         authors = parsed_keywords.get("authors", [])
...
#     def generate_mla_reference(self, paper) -> str:
#         """
...
#     def generate_chicago_reference(self, paper) -> str:
#         """
...
#                     if reference_func:
#                         references.append(reference_func(paper))
#                     else:
