...
if __name__ == "__main__":
    ...
    pipeline.process_papers(query="delegated healthcare tasks AND professional role scope", category="healthcare_management", download_dir="./store", batch_size=6, sources=None)